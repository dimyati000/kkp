			...
			<div class="col-lg-6 pl-50 md-pl-15">
				<div class="sec-title">
					...
					<p class="desc pb-37">
						...
						So you can focus more on growing your business. Eko and Rekan Registered Tax and Legal Consultant 
						Office has a team and consultants who are experienced in their field so that you can reduce business 
						risk in the future.
					</p>
					<div class="row y-middle">
						...
						<div class="col-lg-8 col-md-8">
							<ul class="check-lists">
								...
								<li class="list-item">
									...
									<span class="list-text">Accounting Service</span>
								</li>
								<li class="list-item">
									<span class="icon-list-icon">
										<i class="fa fa-check-circle"></i>
					...
					<div class="row mt-47 md-mt-25">
						<div class="col-lg-6 col-md-4 sm-mb-30">
							<div class="btn-part">
								<a class="readon more know" href="<?php echo site_url('Klien/About') ?>">More</a>
							</div>
						</div>
	...
	<div id="Service" class="rs-services services-style1 pt-120 md-pt-70">
		<div class="container">
			<div class="sec-title text-center mb-50">
				...
				<h2 class="title">
					Providing solutions to problems related to taxation, accounting and law that you need.<br>
					accounting and law that you need.
				</h2>
			</div>
			<div class="rs-carousel owl-carousel" data-loop="true" data-items="3" data-margin="30"
				...
				<div class="services-slider">
					...
					<div class="services-content">
						<div class="services-titles">
							<h4 class="title"><a href="general-construction.html">Tax Service</a></h4>
						</div>
						<p class="services-txt">
							Consultation on Monthly Tax Reporting, Consultation on Annual Tax Reporting, 
							Consultation on Tax Issues, etc.
						</p>
						<div class="services-btn btn-style2">
							<a class="btn-text" href="<?php echo site_url('Jasa/perpajakan') ?>">More<i
				...
				<div class="services-slider">
					...
					<div class="services-content">
						<div class="services-titles">
							<h4 class="title"><a href="property-maintenance.html">accounting services</a></h4>
						</div>
						<p class="services-txt">
							Prepare balance books, accounting software and their implementation 
							handled by consultants and related divisions.
						</p>
						<div class="services-btn btn-style2">
							<a class="btn-text" href="<?php echo site_url('Jasa/akuntansi') ?>">More<i
									class="fi fi-rr-arrow-small-right"></i></a>
						</div>
					</div>
				</div>
				<div class="services-slider">
					...
					<div class="services-content">
						<div class="services-titles">
							<h4 class="title"><a href="project-managment.html">Legal Services</a></h4>
						</div>
						<p class="services-txt">
							Divorce/lawyer/attorney legal services, general crimes, 
							receivables, land, lawsuits for acts against the law.
						</p>
						<div class="services-btn btn-style2">
							<a class="btn-text" href="<?php echo site_url('Jasa/hukum') ?>">More<i
									class="fi fi-rr-arrow-small-right"></i></a>
						</div>
					</div>
				</div>
		...
		<div class="call-action">
			<div class="sec-title text-center">
				...
				<h2 class="title white-color pb-20">
					Start your tax and business consulting and grow with us.
				</h2>
				...
				<div class="btn-part">
					<a class="readon more contact" target="_blank" href="https://api.whatsapp.com/send?phone=6281331907979&text=Halo%20admin%20Kantor%20Konsultan%20Pajak%20dan%20Hukum%20terdaftar%20Eko%20dan%20rekan,%20saya%20mau%20tanya%20.....">Start Consulting</a>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="container">
		<div class="call-action">
			<div class="sec-title text-center">
				...
				<p class="desc desc3 pb-35">
				Terpercaya dalam kerahasiaan data dan kemudahan pengusaha untuk mengatasi permasalahan dalam bidang sesuai kebutuhan klien.
				</p>
				<div class="btn-part">
