					...
					<div class="row">
						<div class="col-lg-4 pr-10 md-pr-15 md-mb-10">
							...
							<div class="textwidget">
								<p class="pb-20">Trusted in data confidentiality and convenience for entrepreneurs to
                                solve problems in the field according to client needs.
                                </p>
								<p><strong>Service Time</strong> :</p>
								<p class="pb-25">Monday - Saturday : 8.00 am to 5.00 pm</p>
							</div>
						...
						<div class="col-lg-4 md-mb-10">
							...
							<ul class="address-widget">
                                ...
                                <li>
                                    ...
                                    <div class="desc">
                                       <a href="tel:(+880)15569569365">(+62) 813-3190-7979</a><br>
                                       <a href="tel:(+880)15569569366">(+62) 856-0757-5713</a>
                                    </div>
                                </li>
                                <li>
                                    <i class="fi fi-rr-envelope-plus"></i>
                                    <div class="desc">
                                        <a href="mailto:support@devsdesign.com">kkpekobudisetiawan@gmail.com</a><br>
                                    </div>
                                </li>
                            </ul>
						</div>
